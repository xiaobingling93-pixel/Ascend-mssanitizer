...
## FAQ
常见问题解答请参见 [《msSanitizer FAQ》](docs/zh/support/faq.md)。

## 贡献指南
1. 贡献流程详见 [《贡献流程说明》](https://gitcode.com/Ascend/msot/blob/master/docs/zh/common/contribute_workflow.md)。   
2. 开发环境搭建、编译及测试方法等，请参见 [《msSanitizer开发指南》](docs/zh/development_guide/develop_guide.md)。

## License
许可条款详见 [《License声明》](https://gitcode.com/Ascend/msot/blob/master/docs/zh/common/license_notice.md)。  

## 免责声明
免责条款详见 [《免责声明》](https://gitcode.com/Ascend/msot/blob/master/docs/zh/common/disclaimer.md)。  
