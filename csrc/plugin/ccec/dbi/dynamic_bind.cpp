...
std::vector<BindStub> bindStubs{
    ...
    {InstrType::LD_B64_IMM, "__sanitizer_report_load_b64_imm", {1, 2, 3}},
    {InstrType::LD_B32_IMM, "__sanitizer_report_load_b32_imm", {1, 2, 3}},
    {InstrType::LD_B16_IMM, "__sanitizer_report_load_b16_imm", {1, 2, 3}},
    {InstrType::LD_B8_IMM, "__sanitizer_report_load_b8_imm", {1, 2, 3}},
    {InstrType::LD_B64_REG, "__sanitizer_report_load_b64_reg", {1, 2, 3}},
    {InstrType::LD_B32_REG, "__sanitizer_report_load_b32_reg", {1, 2, 3}},
    {InstrType::LD_B16_REG, "__sanitizer_report_load_b16_reg", {1, 2, 3}},
    {InstrType::LD_B8_REG, "__sanitizer_report_load_b8_reg", {1, 2, 3}},
