...
SANITIZER_REPORT(vadddeqrelu, __ubuf__ half *dst, __ubuf__ int32_t *src0, __ubuf__ int32_t *src1, uint64_t config)
{
    RecordBinaryOpConfigFunc<RecordType::BINARY_OP>(EXTRA_PARAMS, dst, src0, src1, config, 4, 8, 8, 32, 32, 32);
}

SANITIZER_REPORT(vadddeqrelu, __ubuf__ half *dst, __ubuf__ int32_t *src0, __ubuf__ int32_t *src1, uint8_t repeat,
