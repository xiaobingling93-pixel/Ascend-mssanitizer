...
#include "plugin/ccec/calc_instructions/vshr.cpp"

using namespace Sanitizer;

TEST(VshrCalcInstructions, dump_int_type_records_and_parse_last_expect_success)
{
    ...
    __sanitizer_report_vshr(memInfo.data(), record0.location.fileNo, record0.location.lineNo, record0.location.pc,
        reinterpret_cast<__ubuf__ int16_t *>(record0.dst), reinterpret_cast<__ubuf__ int16_t *>(record0.src),
        3, 42342342, 1);
    __sanitizer_report_vshr(memInfo.data(), record1.location.fileNo, record1.location.lineNo, record1.location.pc,
        ...
        record1.srcRepeatStride, 0);
    __sanitizer_report_vshr(memInfo.data(), record2.location.fileNo, record2.location.lineNo, record2.location.pc,
        ...
        record2.dstRepeatStride, record2.srcRepeatStride, 0, 1, 1);

    __sanitizer_report_vshr(memInfo.data(), record3.location.fileNo, record3.location.lineNo, record3.location.pc,
        reinterpret_cast<__ubuf__ int32_t *>(record3.dst), reinterpret_cast<__ubuf__ int32_t *>(record3.src),
        2, 45345344, 1);
    __sanitizer_report_vshr(memInfo.data(), record4.location.fileNo, record4.location.lineNo, record4.location.pc,
        ...
        record4.dstRepeatStride, record4.srcRepeatStride, 0);
    __sanitizer_report_vshr(memInfo.data(), record5.location.fileNo, record5.location.lineNo, record5.location.pc,
...
TEST(VshrCalcInstructions, dump_uint_type_records_and_parse_last_expect_success)
{
    std::vector<uint8_t> memInfo = CreateMemInfo();
    __gm__ RecordBlockHead *recordBlockHead = reinterpret_cast<__gm__ RecordBlockHead *>(memInfo.data() + sizeof(RecordGlobalHead));
    ...
    __sanitizer_report_vshr(memInfo.data(), record4.location.fileNo, record4.location.lineNo, record4.location.pc,
        ...
        1, record4.repeat, record4.dstBlockStride, record4.srcBlockStride,
        record4.dstRepeatStride, record4.srcRepeatStride, 1);
    __sanitizer_report_vshr(memInfo.data(), record5.location.fileNo, record5.location.lineNo, record5.location.pc,
